...
function startAni() {
    ...
    aniElement.addEventListener("animationend", ev => {
    ...
    aniElement.addEventListener("animationstart", ev => {
        if (ev.animationName === "ani-1") {
            frame1StartTime = Date.now();
            currentFrameItem = aniElement;
        }
    });

    aniElement2.addEventListener("animationend", ev => {
        switch (ev.animationName) {
            case "ani-1":
    ...
    aniElement2.addEventListener("animationstart", ev => {
        if (ev.animationName === "ani-1") {
            frame1StartTime = Date.now();
            currentFrameItem = aniElement2;
        }
    });

    aniElement3.addEventListener("animationend", ev => {
        switch (ev.animationName) {
            case "ani-1":
    ...
    aniElement3.addEventListener("animationstart", ev => {
        if (ev.animationName === "ani-1") {
            frame1StartTime = Date.now();
            currentFrameItem = aniElement3;
        }
    });
